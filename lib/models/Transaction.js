...
module.exports = class Transaction {
  ...
  static async createNewTransaction({ receiver, sender, amount }) {
    ...
    senderProfile.updateBalance(
      Number(senderProfile.balance) - amount,
      senderProfile.id
    );
    receiverProfile.updateBalance(
      Number(receiverProfile.balance) + amount,
      receiverProfile.id
    );
